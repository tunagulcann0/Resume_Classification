...
class TextClassificationModel:
    ...
    def load_data(self):
        ...
        try:
            ...
            self.cleaned_texts = self.cleaned_texts[self.labels.isin(valid_labels)]
            self.labels = self.labels[self.labels.isin(valid_labels)]
    ...
    def split_data(self):
        ...
        try:
            ...
            if self.test_size < min_test_size:
                print(f"Test seti boyutu çok küçük. Test seti boyutu minimum {min_test_size * 100:.2f}% olmalı.")
    ...
    def train_model(self, X_train, y_train):
        ...
        try:
            self.model = RandomForestClassifier(n_estimators=100, class_weight='balanced', random_state=self.random_state)
